...
[![Tests](https://img.shields.io/badge/tests-767%2F779%20passing-brightgreen)](tests/)
...
│   └── replay.py
│
├── tests/                         ← 767/779 passing (enforced by CI)
│   ├── unit/                      ← ~13 files
...
```bash
pytest -q                          # 767/779 passing (~3:40 cold, ~12s unit-only)
