...
[![Tests](https://img.shields.io/badge/tests-438%2F438%20passing-brightgreen)](tests/)
...
│   └── replay.py
│
├── tests/                         ← 438/438 passing (enforced by CI)
│   ├── unit/                      ← ~13 files
...
```bash
pytest -q                          # 438/438 passing (~3m cold, ~12s unit-only)
